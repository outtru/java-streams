...
public class Java8Streams {
    public static void main(String[] args) {
        ...
        // collecting something from stream
        List<Node> nodeMaking = Map.of("key1", 20, "key2", 30)
                .entrySet().stream().map(entry -> new Node(entry.getKey(), entry.getValue())).toList();
        System.out.println(nodeMaking);
    }
}

record Node(String x, int y){ }